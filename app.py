...
def home():
    Kota = "Pasuruan"
    url = "https://maps.googleapis.com/maps/api/place/textsearch/json?query=Tourist+Destination+In+"+Kota+"&type=tourist_attraction&language=en&key=AIzaSyD0cwJyJcz3tMOOQIYZLPNSNecMoNBTrdo"
    ...
    urlphoto1 = "https://maps.googleapis.com/maps/api/place/photo?maxwidth=900&maxheight=900&photo_reference="+photoref1+"&key=AIzaSyD0cwJyJcz3tMOOQIYZLPNSNecMoNBTrdo"
    urlphoto2 = "https://maps.googleapis.com/maps/api/place/photo?maxwidth=900&maxheight=900&photo_reference="+photoref2+"&key=AIzaSyD0cwJyJcz3tMOOQIYZLPNSNecMoNBTrdo"
    urlphoto3 = "https://maps.googleapis.com/maps/api/place/photo?maxwidth=900&maxheight=900&photo_reference="+photoref3+"&key=AIzaSyD0cwJyJcz3tMOOQIYZLPNSNecMoNBTrdo"
    urlphoto4 = "https://maps.googleapis.com/maps/api/place/photo?maxwidth=900&maxheight=900&photo_reference="+photoref4+"&key=AIzaSyD0cwJyJcz3tMOOQIYZLPNSNecMoNBTrdo"
...
def get_poi():
    ...
    url = "https://maps.googleapis.com/maps/api/place/textsearch/json?query=Tourists+Destinations+In+"+Kota+"&type=tourist_attraction&language=en&key=AIzaSyD0cwJyJcz3tMOOQIYZLPNSNecMoNBTrdo"
